...
urlpatterns = [
    ...
    path("api/pppoe/password/",      PPPoEPasswordView.as_view(),       name="pppoe-password"),
    ...
    path("api/admin/routers/provision/",   AdminRouterProvisionView.as_view(), name="admin-router-provision"),
