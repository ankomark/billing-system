    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Admin'), ('admin', 'Admin'), ('staff', 'Staff'), ('customer', 'Customer')], default='admin', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('router_mac', models.CharField(blank=True, max_length=50)),
                ('connection_type', models.CharField(choices=[('fiber', 'Fiber'), ('wireless', 'Wireless'), ('lan', 'LAN')], default='fiber', max_length=20)),
