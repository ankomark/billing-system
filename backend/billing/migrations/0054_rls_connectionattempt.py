"""
Row-Level Security for billing_connectionattempt.
...
codes people typed and the devices they typed them from, which is not something
another operator on the platform should be able to read.
...
TABLES = ["billing_connectionattempt"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("billing", "0053_connection_attempt"),
    ]
