          ...
          <>
            ...
            >
              ...
              <label className="block">
                ...
                />
                {err("email") && (
                  <span className="text-xs text-red-600 mt-1 block">{err("email")}</span>
                )}
              </label>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-5">
              ...
              <Link
                to="/change-password"
                className="inline-block border border-slate-300 hover:bg-slate-50 text-slate-700 rounded-lg px-4 py-2 text-sm font-semibold transition-colors"
              >
                Change password
              </Link>
            </div>
